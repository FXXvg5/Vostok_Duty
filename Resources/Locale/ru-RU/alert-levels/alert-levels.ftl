...
### XD
alert-level-gammaplus = Гамма+
alert-level-gammaplus-announcement = На Станции Чрезвычайно военное положение. Любая малейшая враждебная деятельность карается расстрелом. Слушайтесь только Центкома/Членов ДСО, Капитан и главы теряют Юридическую неприкосновенность и какого либо статуса и не имеют права командовать кем либо. Да хранит вас Корпорация.
alert-level-gammaplus-instructions = Обратитесь к главе своего отдела за указаниями. Носите свою ID-карту на поясе. Включите режим «координат» на комбинезоне. Находитесь в любой общественной зоне, если иное не предписано ДСО/Центком. Исполняйте приказы Членов ДСО/Центком в полном объёме. Бюрократические нормы отменены. Корпорация Nanotrasen заверяет вас: угроза будет вскоре нейтрализована.
